...
function Ripple(obj)
	spawn(function()
		...
		Ripple.ZIndex = 8
		Ripple.Image = "rbxassetid://101448"
...
if theme == 'dark' then
    ...
    beijingColor = Color3.fromRGB(25, 25, 25)
      ...
      DropShadow.Image = "rbxassetid://101448" --背景
...
Open.Active = true
Open.Draggable = true
Open.Image = "rbxassetid://101448"
Open.MouseButton1Click:Connect(function()
  Main.Visible = not Main.Visible
  Open.Image = Main.Visible and "rbxassetid://101448" or "rbxassetid://101448" --开关的图
end)
...
UIG.Parent = Open
      ...
      function window.Tab(window, name, icon)
        ...
        TabIco.Image = "rbxassetid://101448" or icon and "rbxassetid://"..icon
