...
if theme == 'dark' then
    ...
    beijingColor = Color3.fromRGB(25, 25, 25)
      ...
      DropShadow.Image = "rbxassetid://1754734197908" --背景
...
Open.Active = true
Open.Draggable = true
Open.Image = "rbxassetid://1754734197908"
Open.MouseButton1Click:Connect(function()
  Main.Visible = not Main.Visible
  Open.Image = Main.Visible and "rbxassetid://1754734197908" or "rbxassetid://1754734197908" --开关的图
end)
...
UIG.Parent = Open
      ...
      function window.Tab(window, name, icon)
        ...
        TabIco.Image = "rbxassetid://1754734197908" or icon and "rbxassetid://"..icon
